#	.NET
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\4.6 and 4.6.1 hotfix rollup W2K12 KB3146714 X64"
(new-object System.Net.WebClient).DownloadFile("http://download.microsoft.com/download/e/f/1/ef1fb34b-58cb-4568-85ec-fa359387e328/windows8-rt-kb3146714-x64.msu", "$env:OneDriveConsumer\PSL\.NET\4.6 and 4.6.1 hotfix rollup W2K12 KB3146714 X64\windows8-rt-kb3146714-x64.msu")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\4.6 and 4.6.1 hotfix rollup W2K12 R2 KB3146715 X64"
(new-object System.Net.WebClient).DownloadFile("http://download.microsoft.com/download/e/f/1/ef1fb34b-58cb-4568-85ec-fa359387e328/windows8.1-kb3146715-x64.msu", "$env:OneDriveConsumer\PSL\.NET\4.6 and 4.6.1 hotfix rollup W2K12 R2 KB3146715 X64\windows8.1-kb3146715-x64.msu")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\4.6 and 4.6.1 hotfix rollup W2K8 R2 KB3146716 X64 & X86"
(new-object System.Net.WebClient).DownloadFile("http://download.microsoft.com/download/e/f/1/ef1fb34b-58cb-4568-85ec-fa359387e328/ndp461-kb3146716-x86-x64-enu.exe", "$env:OneDriveConsumer\PSL\.NET\4.6 and 4.6.1 hotfix rollup W2K8 R2 KB3146716 X64 & X86\ndp461-kb3146716-x86-x64-enu.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\Framework 1"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/e/b/2/eb247c2a-e6b3-4694-98a2-b27111d233dd/dotnetredist.exe", "$env:OneDriveConsumer\PSL\.NET\Framework 1\dotnetredist.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\\.NET\Framework 2"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/a/3/f/a3f1bf98-18f3-4036-9b68-8e6de530ce0a/NetFx64.exe", "$env:OneDriveConsumer\PSL\.NET\Framework 2\NetFx64.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\Framework 3"
(new-object System.Net.WebClient).DownloadFile("http://download.microsoft.com/download/1/6/7/167F0D79-9317-48AE-AEDB-17120579F8E2/NDP451-KB2858728-x86-x64-AllOS-ENU.exe", "$env:OneDriveConsumer\PSL\.NET\Framework 3\NDP451-KB2858728-x86-x64-AllOS-ENU.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\Framework 3.5 Incl. sp1"
(new-object System.Net.WebClient).DownloadFile("http://download.microsoft.com/download/2/0/E/20E90413-712F-438C-988E-FDAA79A8AC3D/dotnetfx35.exe", "$env:OneDriveConsumer\PSL\.NET\Framework 3.5 Incl. sp1\dotnetfx35.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\Framework 4.5.2"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/9/5/A/95A9616B-7A37-4AF6-BC36-D6EA96C8DAAE/dotNetFx40_Full_x86_x64.exe", "$env:OneDriveConsumer\PSL\.NET\Framework 4.5.2\dotNetFx40_Full_x86_x64.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\Framework 4.6"
(new-object System.Net.WebClient).DownloadFile("http://download.microsoft.com/download/C/3/A/C3A5200B-D33C-47E9-9D70-2F7C65DAAD94/NDP46-KB3045557-x86-x64-AllOS-ENU.exe", "$env:OneDriveConsumer\PSL\.NET\Framework 4.6\NDP46-KB3045557-x86-x64-AllOS-ENU.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\Framework 4.6.1"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/E/4/1/E4173890-A24A-4936-9FC9-AF930FE3FA40/NDP461-KB3102436-x86-x64-AllOS-ENU.exe", "$env:OneDriveConsumer\PSL\.NET\Framework 4.6.1\NDP461-KB3102436-x86-x64-AllOS-ENU.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\Framework 4.6.2"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/F/9/4/F942F07D-F26F-4F30-B4E3-EBD54FABA377/NDP462-KB3151800-x86-x64-AllOS-ENU.exe", "$env:OneDriveConsumer\PSL\.NET\Framework 4.6.2\NDP462-KB3151800-x86-x64-AllOS-ENU.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\Framework 4.7"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/D/D/3/DD35CC25-6E9C-484B-A746-C5BE0C923290/NDP47-KB3186497-x86-x64-AllOS-ENU.exe", "$env:OneDriveConsumer\PSL\.NET\Framework 4.7\NDP47-KB3186497-x86-x64-AllOS-ENU.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\Framework 4.7.1"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/9/E/6/9E63300C-0941-4B45-A0EC-0008F96DD480/NDP471-KB4033342-x86-x64-AllOS-ENU.exe", "$env:OneDriveConsumer\PSL\.NET\Framework 4.7.1\NDP471-KB4033342-x86-x64-AllOS-ENU.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\Framework 4.7.2"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/6/E/4/6E48E8AB-DC00-419E-9704-06DD46E5F81D/NDP472-KB4054530-x86-x64-AllOS-ENU.exe", "$env:OneDriveConsumer\PSL\.NET\Framework 4.7.2\NDP472-KB4054530-x86-x64-AllOS-ENU.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\Framework 4.8"
(new-object System.Net.WebClient).DownloadFile("https://download.visualstudio.microsoft.com/download/pr/7afca223-55d2-470a-8edc-6a1739ae3252/abd170b4b0ec15ad0222a809b761a036/ndp48-x86-x64-allos-enu.exe", "$env:OneDriveConsumer\PSL\.NET\Framework 4.8\ndp48-x86-x64-allos-enu.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\Framework Repair Tool"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/2/B/D/2BDE5459-2225-48B8-830C-AE19CAF038F1/NetFxRepairTool.exe", "$env:OneDriveConsumer\PSL\.NET\Framework Repair Tool\NetFxRepairTool.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\.NET\.NET Core"
...
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\HTTrack Portable"
...
#	L
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\LastPass"
(new-object System.Net.WebClient).DownloadFile("https://download.cloud.lastpass.com/windows_installer/LastPassInstaller.exe", "$env:OneDriveConsumer\PSL\LastPass\LastPassInstaller.exe")
#	M
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Microsoft Online Services Sign-in Assistant for IT Professionals"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/7/1/E/71EF1D05-A42C-4A1F-8162-96494B5E615C/msoidcli_64bit.msi", "$env:OneDriveConsumer\PSL\Microsoft Online Services Sign-in Assistant for IT Professionals\msoidcli_64bit.msi")
...
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/7/9/8/7982ED00-C0F5-44BB-8B40-768951AE4CC7/Exchange2013-x64-cu22.exe", "$env:OneDriveConsumer\PSL\Microsoft Exchange 2013\CU22 EN X64\Exchange2013-x64-cu22.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Microsoft Exchange 2013\CU23 EN X64"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/7/F/D/7FDCC96C-26C0-4D49-B5DB-5A8B36935903/Exchange2013-x64-cu23.exe", "$env:OneDriveConsumer\PSL\Microsoft Exchange 2013\CU23 EN X64\Exchange2013-x64-cu23.exe")
# Exchange 2016
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Microsoft Exchange 2016\CU10 EN X64 ISO"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/B/C/9/BC9C77DA-97D9-43D8-A3F8-50D8AF89E3FA/ExchangeServer2016-x64-cu10.iso", "$env:OneDriveConsumer\PSL\Microsoft Exchange 2016\CU10 EN X64 ISO\ExchangeServer2016-x64-cu10.iso")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Microsoft Exchange 2016\CU11 EN X64 ISO"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/6/6/F/66F70200-E2E8-4E73-88F9-A1F6E3E04650/ExchangeServer2016-x64-cu11.iso", "$env:OneDriveConsumer\PSL\Microsoft Exchange 2016\CU11 EN X64 ISO\ExchangeServer2016-x64-cu11.iso")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Microsoft Exchange 2016\CU12 EN X64 ISO"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/2/5/8/258D30CF-CA4C-433A-A618-FB7E6BCC4EEE/ExchangeServer2016-x64-cu12.iso", "$env:OneDriveConsumer\PSL\Microsoft Exchange 2016\CU12 EN X64 ISO\ExchangeServer2016-x64-cu12.iso")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Microsoft Exchange 2016\CU13 EN X64 ISO"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/5/9/6/59681DAE-AB62-4854-8DEC-CA25FFEFE3B3/ExchangeServer2016-x64-cu13.iso", "$env:OneDriveConsumer\PSL\Microsoft Exchange 2016\CU13 EN X64 ISO\ExchangeServer2016-x64-cu13.iso")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Microsoft Exchange 2016\CU14 EN X64 ISO"
...
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Microsoft Visual C++\Redistributable 2008 x64"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/d/2/4/d242c3fb-da5a-4542-ad66-f9661d0a8d19/vcredist_x64.exe", "$env:OneDriveConsumer\PSL\Microsoft Visual C++\Redistributable 2008 x64\vcredist_x64.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Microsoft Visual C++\Redistributable 2010 x64"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/3/2/2/3224B87F-CFA0-4E70-BDA3-3DE650EFEBA5/vcredist_x64.exe", "$env:OneDriveConsumer\PSL\Microsoft Visual C++\Redistributable 2010 x64\vcredist_x64.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Microsoft Visual C++\Redistributable 2012 x64"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/1/6/B/16B06F60-3B20-4FF2-B699-5E9B7962F9AE/VSU_4/vcredist_x64.exe", "$env:OneDriveConsumer\PSL\Microsoft Visual C++\Redistributable 2012 x64\vcredist_x64.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Microsoft Visual C++\Redistributable 2013 x64"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/2/E/6/2E61CFA4-993B-4DD4-91DA-3737CD5CD6E3/vcredist_x64.exe", "$env:OneDriveConsumer\PSL\Microsoft Visual C++\Redistributable 2013 x64\vcredist_x64.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Microsoft Visual C++\Redistributable 2015 x64"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/9/3/F/93FCF1E7-E6A4-478B-96E7-D4B285925B00/vc_redist.x64.exe", "$env:OneDriveConsumer\PSL\Microsoft Visual C++\Redistributable 2015 x64\vc_redist.x64.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Microsoft Visual C++\Redistributable 2015 Update 3 x64"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/6/D/F/6DF3FF94-F7F9-4F0B-838C-A328D1A7D0EE/vc_redist.x64.exe", "$env:OneDriveConsumer\PSL\Microsoft Visual C++\Redistributable 2015 Update 3 x64\vc_redist.x64.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Microsoft Visual C++\Redistributable 2019 x64"
(new-object System.Net.WebClient).DownloadFile("https://download.visualstudio.microsoft.com/download/pr/9e04d214-5a9d-4515-9960-3d71398d98c3/1e1e62ab57bbb4bf5199e8ce88f040be/vc_redist.x64.exe", "$env:OneDriveConsumer\PSL\Microsoft Visual C++\Redistributable 2019 x64\vc_redist.x64.exe")
#	N
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\NewsLeecher 7\Beta 15"
(new-object System.Net.WebClient).DownloadFile("https://www.newsleecher.com/nl_setup_beta.exe", "$env:OneDriveConsumer\PSL\NewsLeecher 7\Beta 15\nl_setup_beta.exe")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\NewsLeecher 7\Final"
(new-object System.Net.WebClient).DownloadFile("https://www.newsleecher.com/nl_setup.exe", "$env:OneDriveConsumer\PSL\NewsLeecher 7\Final\nl_setup.exe")
...
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell\3.0 for W2K8 R2 X64 ENG"
(new-object System.Net.WebClient).DownloadFile("http://download.microsoft.com/download/E/7/6/E76850B8-DA6E-4FF5-8CCE-A24FC513FD16/Windows6.1-KB2506143-x64.msu", "$env:OneDriveConsumer\PSL\PowerShell\3.0 for W2K8 R2 X64 ENG\Windows6.1-KB2506143-x64.msu")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell\3.0 for Windows 7 X64 ENG"
(new-object System.Net.WebClient).DownloadFile("http://download.microsoft.com/download/E/7/6/E76850B8-DA6E-4FF5-8CCE-A24FC513FD16/Windows6.0-KB2506146-x64.msu", "$env:OneDriveConsumer\PSL\PowerShell\3.0 for Windows 7 X64 ENG\Windows6.0-KB2506146-x64.msu")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell\4.0 X64 ENG"
(new-object System.Net.WebClient).DownloadFile("http://download.microsoft.com/download/3/D/6/3D61D262-8549-4769-A660-230B67E15B25/Windows6.1-KB2819745-x64-MultiPkg.msu", "$env:OneDriveConsumer\PSL\PowerShell\4.0 X64 ENG\Windows6.1-KB2819745-x64-MultiPkg.msu")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell\5.0 for W2K12 X64"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/2/C/6/2C6E1B4A-EBE5-48A6-B225-2D2058A9CEFB/W2K12-KB3134759-x64.msu", "$env:OneDriveConsumer\PSL\PowerShell\5.0 for W2K12 X64\W2K12-KB3134759-x64.msu")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell\5.0 for Win7 And W2K8R2 X64"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/2/C/6/2C6E1B4A-EBE5-48A6-B225-2D2058A9CEFB/Win7AndW2K8R2-KB3134760-x64.msu", "$env:OneDriveConsumer\PSL\PowerShell\5.0 for Win7 And W2K8R2 X64\Win7AndW2K8R2-KB3134760-x64.msu")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell\5.0 for Win8.1 And W2K12R2 X64"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/2/C/6/2C6E1B4A-EBE5-48A6-B225-2D2058A9CEFB/Win8.1AndW2K12R2-KB3134758-x64.msu", "$env:OneDriveConsumer\PSL\PowerShell\5.0 for Win8.1 And W2K12R2 X64\Win8.1AndW2K12R2-KB3134758-x64.msu")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell\5.0 for Windows 7 X86"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/2/C/6/2C6E1B4A-EBE5-48A6-B225-2D2058A9CEFB/Win7-KB3134760-x86.msu", "$env:OneDriveConsumer\PSL\PowerShell\5.0 for Windows 7 X86\Win7-KB3134760-x86.msu")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell\5.0 for Windows 8.1 x86"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/2/C/6/2C6E1B4A-EBE5-48A6-B225-2D2058A9CEFB/Win8.1-KB3134758-x86.msu", "$env:OneDriveConsumer\PSL\PowerShell\5.0 for Windows 8.1 x86\Win8.1-KB3134758-x86.msu")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell\5.1 for W2K12 X64 ENG"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/6/F/5/6F5FF66C-6775-42B0-86C4-47D41F2DA187/W2K12-KB3191565-x64.msu", "$env:OneDriveConsumer\PSL\PowerShell\5.1 for W2K12 X64 ENG\W2K12-KB3191565-x64.msu")
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell\5.1 for Win7 - W2K8R2 X64 ENG"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/6/F/5/6F5FF66C-6775-42B0-86C4-47D41F2DA187/Win7AndW2K8R2-KB3191566-x64.zip", "$env:OneDriveConsumer\PSL\PowerShell\5.1 for Win7 - W2K8R2 X64 ENG\Win7AndW2K8R2-KB3191566-x64.zip")
...
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell Core\Linux X64"
bitsadmin /transfer mydownload /dynamic /download /priority FOREGROUND "https://github.com/PowerShell/PowerShell/releases/download/v6.2.3/powershell-6.2.3-linux-x64.tar.gz" "$env:OneDriveConsumer\PSL\PowerShell Core\Linux X64\powershell-6.2.3-linux-x64.tar.gz"
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell Core\OSX X64"
bitsadmin /transfer mydownload /dynamic /download /priority FOREGROUND "https://github.com/PowerShell/PowerShell/releases/download/v6.2.3/powershell-6.2.3-osx-x64.tar.gz" "$env:OneDriveConsumer\PSL\PowerShell Core\OSX X64\powershell-6.2.0-osx-x64.tar.gz"
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell Core\RedHat X86-X64"
bitsadmin /transfer mydownload /dynamic /download /priority FOREGROUND "https://github.com/PowerShell/PowerShell/releases/download/v6.2.3/powershell-6.2.3-1.rhel.7.x86_64.rpm" "$env:OneDriveConsumer\PSL\PowerShell Core\RedHat X86-X64\powershell-6.2.0-1.rhel.7.x86_64.rpm"
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell Core\Debian 9 X64"
bitsadmin /transfer mydownload /dynamic /download /priority FOREGROUND "https://github.com/PowerShell/PowerShell/releases/download/v6.2.3/powershell_6.2.3-1.debian.9_amd64.deb" "$env:OneDriveConsumer\PSL\PowerShell Core\Debian 9 X64\powershell_6.2.0-1.debian.9_amd64.deb"
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\PowerShell Core\Ubuntu 18 X64"
bitsadmin /transfer mydownload /dynamic /download /priority FOREGROUND "https://github.com/PowerShell/PowerShell/releases/download/v6.2.3/powershell_6.2.3-1.ubuntu.18.04_amd64.deb" "$env:OneDriveConsumer\PSL\PowerShell Core\Ubuntu 18 X64\powershell_6.2.0-1.ubuntu.18.04_amd64.deb"
#	Q
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\QuickPar 0.9.1.0"
(new-object System.Net.WebClient).DownloadFile("http://download.quickpar.org.uk/download.php/QuickPar-0.9.1.0.exe", "$env:OneDriveConsumer\PSL\QuickPar 0.9.1.0\QuickPar-0.9.1.0.exe")
#	R
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\RDCMan RemoteDesktopConnectionManager"
(new-object System.Net.WebClient).DownloadFile("https://download.microsoft.com/download/A/F/0/AF0071F3-B198-4A35-AA90-C68D103BDCCF/rdcman.msi", "$env:OneDriveConsumer\PSL\RDCMan RemoteDesktopConnectionManager\rdcman.msi")
...
New-Item -ItemType Directory -Force -Path "$env:OneDriveConsumer\PSL\Skype for Business Online Windows PowerShell Module"
...
#   bitsadmin /transfer mydownload /dynamic /download /priority FOREGROUND "https://url" "$env:OneDriveConsumer\PSL\app name\filename.exe"